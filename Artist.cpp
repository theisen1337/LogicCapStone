			...
			for (int l = 0; l < chunkDim; l++)
			{
				for (int m = 0; m < chunkDim; m++)
				{
					...
					al_draw_filled_rectangle(
						...
						al_map_rgb(1, 1, 1));al_load_bitmap("Tiles//grass.png")*/
...
void Artist::loadTilePic(Tile::Types type)
{
	//Tile::Types type = tile.getType();
